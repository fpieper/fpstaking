    ...
    column [ spacing normal, width fill ]
        ...
        , el [ width <| maximum 1000 fill, centerX ] <|
            row_
                ...
                , viewBenefit device paid "Low Fees" [ text "My validator fee is 0% until February (in mid February 3.4% again). Low fees combined with high uptime ensure that your rewards are maximised. You can calculate your expected APY in my staking calculator." ]
